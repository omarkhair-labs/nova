...
class GroupManagementRemoteRepository(
    context: Context,
    ...
    override suspend fun removeAvatar(conversationId: Long): ApiResult<ManagedGroupDetail> {
        return authenticatedCall { token ->
            when (
                val response = requestJson(
                    path = "conversations/$conversationId/group/manage/",
    ...
    private fun parseDetail(json: JSONObject): ManagedGroupDetail {

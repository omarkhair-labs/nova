...
from .profile import ProfileReelsView
from . import (
    ReelDetailView,
    ReelFeedView,
    ReelLikeView,
...
urlpatterns = [
    ...
    path("reel-comments/<int:comment_id>/", ThreadReelCommentDetailView.as_view(), name="reel-comment-detail"),
    path("reel-comment-replies/<int:reply_id>/", ReelCommentReplyDetailView.as_view(), name="reel-comment-reply-detail"),
]

...
class WeeklyMemoryView(APIView):
    ...
    def get(self, request):
        ...
        highlights.sort(key=_highlight_timestamp, reverse=True)
        highlights = highlights[:MEMORY_HIGHLIGHT_LIMIT]
        highlights.sort(key=_highlight_timestamp)
        ...
        room_by_id = {
            ...
            for item in room_qs.filter(conversation_id__in=room_ids)
